...
COLUMN_TYPE_ALIASES["text"] = "shortText";
COLUMN_TYPE_ALIASES["long text"] = "longText";
COLUMN_TYPE_ALIASES["single option"] = "singleOption";
COLUMN_TYPE_ALIASES["dropdown"] = "singleOption";
COLUMN_TYPE_ALIASES["drop down"] = "singleOption";
COLUMN_TYPE_ALIASES["select"] = "singleOption";
COLUMN_TYPE_ALIASES["singleselect"] = "singleOption";
COLUMN_TYPE_ALIASES["single_select"] = "singleOption";
COLUMN_TYPE_ALIASES["single-select"] = "singleOption";
COLUMN_TYPE_ALIASES["multiple options"] = "multipleOptions";
COLUMN_TYPE_ALIASES["multiselect"] = "multipleOptions";
COLUMN_TYPE_ALIASES["multi_select"] = "multipleOptions";
COLUMN_TYPE_ALIASES["multi-select"] = "multipleOptions";
COLUMN_TYPE_ALIASES["date and time"] = "dateAndTime";
COLUMN_TYPE_ALIASES["date"] = "dateAndTime";
COLUMN_TYPE_ALIASES["datefield"] = "dateAndTime";
COLUMN_TYPE_ALIASES["date_field"] = "dateAndTime";
COLUMN_TYPE_ALIASES["date-field"] = "dateAndTime";
